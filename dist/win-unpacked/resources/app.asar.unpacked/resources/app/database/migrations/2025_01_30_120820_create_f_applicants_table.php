...
return new class extends Migration
{
    ...
    {
        Schema::create('f_applicants', function (Blueprint $table) {
            ...
            $table->date('application_date')->default(now()); // تاريخ التقديم (Application Date)
            ...
            $table->string('hijab_type')->nullable(); // نوع حجابك؟
            ...
            $table->string('nature_of_job')->nullable(); // إن كنت تعملين، فما طبيعة العمل؟ 
            ...
            $table->boolean('accepts_polygamy')->default(false); // هل تقبلين مطلقا أو أرملا
    ...
    {
        Schema::dropIfExists('f_applicants');
    }
};
