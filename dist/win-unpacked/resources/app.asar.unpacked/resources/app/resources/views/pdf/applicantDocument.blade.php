...
<body>
 <div>
        <div class="header">
            <img width="100px" src="{{ asset('assets/icons/male-dark.svg') }}" alt="" />
        ...
        <ul>
            ...
            <li style="font-weight: bold;">ملتحي: <span style="font-weight: normal;">{{ $data->has_beard ? "نعم" : "لا" }}</span></li>
            <li style="font-weight: bold;">عقيدتك: <span style="font-weight: normal;">{{ $data->creed }}</span></li>
            <li style="font-weight: bold;">تصلي الفريضة مع الجماعة: <span style="font-weight: normal;">{{ $data->prays_with_jamaah ? "نعم" : "لا" }}</span></li>
            <li style="font-weight: bold;">شيوخك ممن تأخد الفتوى: <span style="font-weight: normal;">{{ $data->scholars_you_follow }}</span></li>
            <li style="font-weight: bold;">تعاني من مرض معين: <span style="font-weight: normal;">{{ $data->medical_illness ? "نعم" : "لا" }}</span></li>
        ...
        <ul>
            <li style="font-weight: bold;">تقبل بها عاملة أو جامعية: <span style="font-weight: normal;">{{ $data->accepts_working_wife ? "نعم" : "لا" }}</span></li>
            <li style="font-weight: bold;">المدن التي تفضل الزواج منها: <span style="font-weight: normal;">{{ $data->preferred_cities_for_marriage }}</span></li>
            <li style="font-weight: bold;">تقبل مطلقة او ارملة: <span style="font-weight: normal;">{{ $data->accepts_divorced_or_widowed ? "نعم" : "لا" }}</span></li>
            <li style="font-weight: bold;">أقصى العمر الذي تقبل به: <span style="font-weight: normal;">{{ $data->maximum_accepted_age }}</span></li>
